...
public class LiftList extends GenericBeanList<Lifter> implements
    ...
    public LiftList(SessionData groupData, EditingView parentView, AnnouncerView.Mode mode, CompetitionApplication app) {
        super(app, Lifter.class, buildCaption(mode, groupData)); //$NON-NLS-1$
    ...
    private static String buildCaption(AnnouncerView.Mode mode, SessionData groupData) {
        CompetitionApplication current = CompetitionApplication.getCurrent(); // ok due to static
        ...
        if (property == table) {
            ...
            if (parentView != null) {
                ...
                parentView.setStickyEditor(true); // since the user selected
                                                  ...
                                                  // by others.
                lifter.checkStartingTotalsRule(false, (Notifyable) parentView);
            }
        }
    }
    ...
    protected void createToolbarButtons(HorizontalLayout tableToolbar1) {
        ...
        if (mode == AnnouncerView.Mode.ANNOUNCER) {
            ...
            final Button.ClickListener refreshClickListener = new Button.ClickListener() { //$NON-NLS-1$
                ...
                public void buttonClick(ClickEvent event) {
                    LoggerUtils.mdcSetup(getLoggingId(), getGroupData());
        ...
        final Button.ClickListener publicAddressClickListener = new Button.ClickListener() { //$NON-NLS-1$
            ...
            public void buttonClick(ClickEvent event) {
                ...
                PublicAddressForm.editPublicAddress(LiftList.this, masterData, parentView);
            }
        };
