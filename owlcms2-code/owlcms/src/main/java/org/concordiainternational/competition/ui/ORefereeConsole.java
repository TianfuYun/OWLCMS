...
public class ORefereeConsole extends VerticalLayout implements DecisionEventListener, ApplicationView, CloseListener,
        IRefereeConsole {
    ...
    public ORefereeConsole(boolean initFromFragment, String fragment, String viewName, CompetitionApplication app) {
        this.app = app;
        if (initFromFragment) {
    ...
    public void setIndex(int refereeIndex) {
        synchronized (app) {
            ...
            refereeReminder.setValue(refereeLabel(refereeIndex));
            UriFragmentUtility uriFragmentUtility = app.getUriFragmentUtility();
