...
public class JXLSWeighInSheet extends JXLSWorkbookStreamSource {
    ...
    protected void getSortedLifters() {
        ...
        if (currentGroup != null) {
            ...
            this.lifters = LifterSorter.displayOrderCopy(Lifter.getAllCurrentGroup(currentGroup,isExcludeNotWeighed()));
        } else {
            this.lifters = LifterSorter.displayOrderCopy(Lifter.getAll(isExcludeNotWeighed()));
        }
