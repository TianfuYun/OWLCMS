...
public class MTimekeeperConsole extends VerticalLayout implements
    ...
    public MTimekeeperConsole(boolean initFromFragment, String fragment, String viewName, CompetitionApplication app) {
        if (initFromFragment) {
    ...
    public void registerAsListener() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        synchronized (app) {
                            ...
                            Lifter eventLifter = sessionDataUpdateEvent.getCurrentLifter();
        ...
        groupData.addListener(sessionDataUpdateEventListener); //$NON-NLS-1$
    ...
    public void unregisterAsListenerDoIt() {
        ...
        if (sessionDataUpdateEventListener != null)
            groupData.removeListener(sessionDataUpdateEventListener);
    }
