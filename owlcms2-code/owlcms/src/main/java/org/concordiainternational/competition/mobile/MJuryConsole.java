...
public class MJuryConsole extends VerticalLayout implements DecisionEventListener, ApplicationView, CloseListener,
        IRefereeConsole {
    ...
    public MJuryConsole(boolean initFromFragment, String fragment, String viewName, CompetitionApplication app) {
        if (initFromFragment) {
     ...
     *
     * @see
     * org.concordiainternational.competition.ui.IRefereeConsole#updateEvent(org.concordiainternational.competition.decision.DecisionEvent)
     */
    @Override
    ...
    public String getLoggingId() {
        return getViewName() + (juryIndex != null ? "[" + juryIndex + "]" : ""); // + getInstanceId();
    }
