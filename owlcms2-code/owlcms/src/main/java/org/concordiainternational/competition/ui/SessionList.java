...
public class SessionList extends GenericHbnList<CompetitionSession> implements ApplicationView {
    ...
    public SessionList(boolean initFromFragment, String fragment, String viewName, CompetitionApplication app) {
        super(app, CompetitionSession.class, Messages.getString(
                "GroupList.Groups", app.getLocale())); //$NON-NLS-1$
        if (initFromFragment) {
