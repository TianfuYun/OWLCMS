...
public class SessionForm extends Form {
    ...
    public SessionForm(CompetitionApplication app) {
        super();
        this.app = app;
        this.setFormFieldFactory(new CommonFieldFactory(app));
    ...
    Button ok = new Button(Messages.getString("Common.OK", CompetitionApplication.getCurrentLocale()), new Button.ClickListener() {
        ...
        public void buttonClick(ClickEvent event) {
            ...
            Session hbnSession = app.getHbnSession();
    ...
    public GenericList<?> getParentList() {
        return (GenericList<?>) parentList;
    }

    public void setParentList(GenericList<?> genericLift) {
        this.parentList = genericLift;
    }
