...
public abstract class JXLSWorkbookStreamSource implements StreamResource.StreamSource {
    ...
    protected List<Lifter> sortedMen;
    protected List<Lifter> sortedWomen;
...
//        System.err.println("JXLSWorkbookStreamSource init");
        ...
        if (lifters != null) {
            ...
            getReportingBeans().put("sortedMen", sortedMen);
            getReportingBeans().put("sortedWomen", sortedWomen);
        }
    ...
    public InputStream getStream() {
        try {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        LoggerUtils.mdcSetup(app.getCurrentView().getLoggingId(),null);
