...
public class MRefereeConsole extends VerticalLayout implements DecisionEventListener, ApplicationView, CloseListener,
    ...
    public MRefereeConsole(boolean initFromFragment, String fragment, String viewName, CompetitionApplication app) {
        if (initFromFragment) {
    ...
    public String getLoggingId() {
        return getViewName() + (refereeIndex != null ? "[" + refereeIndex + "]" : "");// + getInstanceId();
    }
