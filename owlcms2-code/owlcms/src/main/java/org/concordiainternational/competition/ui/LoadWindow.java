...
public class LoadWindow extends Window implements Property.ValueChangeListener,
    ...
    private SessionDataUpdateEventListener groupDataListener;

    private Menu menu;

    CompetitionApplication app;

    public LoadWindow(Menu menu, CompetitionApplication app) {
        super();
        this.app = app;
        this.menu = menu;
    ...
    private void registerAsListener(final Locale locale) {
        ...
        groupDataListener = new SessionData.SessionDataUpdateEventListener() {
            @Override
    ...
    public void valueChange(Property.ValueChangeEvent event) {
        ...
        try {
            ...
            app.getHbnSession().merge(masterData.getPlatform());
    ...
    public String getLoggingId() {
        return "(LoadWindow" + ")"; //+ getInstanceId() + ")";
    }
