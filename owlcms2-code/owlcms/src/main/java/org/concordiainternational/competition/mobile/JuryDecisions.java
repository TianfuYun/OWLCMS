...
public class JuryDecisions extends VerticalLayout implements ApplicationView {
    ...
    public JuryDecisions(boolean initFromFragment, String fragment, String viewName, CompetitionApplication app) {
        this.app = app;
        ...
        juryDecisions = new RefereeDecisions(initFromFragment, fragment, viewName, false, true, true, app);
        refDecisions = new RefereeDecisions(initFromFragment, fragment, viewName, false, false, false, app);
    ...
    public void registerAsListener() {
        ...
        LoggerUtils.mdcSetup(getLoggingId(),refDecisions.masterData);
    }
