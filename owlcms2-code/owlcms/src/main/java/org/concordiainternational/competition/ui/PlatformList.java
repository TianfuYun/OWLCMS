...
public class PlatformList extends GenericHbnList<Platform> implements ApplicationView {
    ...
    public PlatformList(boolean initFromFragment, String fragment, String viewName, CompetitionApplication app) {
        super(app, Platform.class, Messages.getString(
                    ...
                    public Component generateCell(Table source, final Object itemId, Object columnId) {
                        ...
                        del.addListener(new ClickListener() {
                            ...
                            public void buttonClick(ClickEvent event) {
                                try {
//                                    HbnContainer<Platform>.EntityItem<Platform> platform = (HbnContainer<Platform>.EntityItem<Platform>) table.getContainerDataSource().getItem(itemId);
//                                    Platform platformBean = (Platform) platform.getPojo();
                                    deleteItem(itemId);
//                                    Platform.removePlatform(platformBean);
                                    Platform.getAll(); // recompute cache
                        ...
                        if (!table.isEditable()) {
                            ...
                            ls.addListener(new ValueChangeListener() {
                                ...
                                public void valueChange(ValueChangeEvent event) {
                                    ...
                                    Platform.getAll(); // recompute cache
                                    String mixerName = Platform.getByName(pl.getName()).getMixerName();
                                    String mixerName2 = pl.getMixerName();

                                    if (!Objects.equals(mixerName, mixerName2)) {
