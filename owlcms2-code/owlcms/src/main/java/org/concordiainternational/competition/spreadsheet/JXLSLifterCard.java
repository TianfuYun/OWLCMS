...
public class JXLSLifterCard extends JXLSWorkbookStreamSource {
    ...
    protected void getSortedLifters() {
        ...
        if (currentGroup != null) {
            ...
            this.lifters = LifterSorter.registrationOrderCopy(Lifter.getAllCurrentGroup(currentGroup, false));
        } else {
            this.lifters = LifterSorter.registrationOrderCopy(Lifter.getAll(false));
        }
    }
