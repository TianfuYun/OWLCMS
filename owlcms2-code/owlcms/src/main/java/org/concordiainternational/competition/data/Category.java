...
public class Category implements Serializable {
    ...
    public static void insertStandardCategories(Session sess) {
        if (sess.createCriteria(Category.class).list().size() == 0) {
            ...
            sess.save(new Category(
                    Messages.getString("Category.fgt63", locale), 63.0, 999.0, Gender.F.toString(), false)); //$NON-NLS-1$
            ...
            sess.save(new Category(
                    Messages.getString("Category.fgt75", locale), 75.0, 999.0, Gender.F.toString(), false)); //$NON-NLS-1$
            sess.save(new Category(Messages.getString("Category.f90", locale), 75.0, 90.0, Gender.F.toString(), true)); //$NON-NLS-1$
            sess.save(new Category(
                    Messages.getString("Category.fgt90", locale), 90.0, 999.0, Gender.F.toString(), true)); //$NON-NLS-1$
