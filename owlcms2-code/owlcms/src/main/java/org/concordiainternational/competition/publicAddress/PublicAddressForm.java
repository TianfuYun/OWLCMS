...
public class PublicAddressForm extends Form implements Window.CloseListener {
    ...
    public static void editPublicAddress(GenericList<?> list,
            SessionData masterData, EditingView parentView) {
        ...
        PublicAddressForm form = new PublicAddressForm(masterData, parentView);
    ...
    private CountdownCombo countdownCombo;

    public class PublicAddressFormFieldFactory implements FormFieldFactory {

        public PublicAddressFormFieldFactory(EditingView parentView) {
        ...
        public Field createField(Item item, Object propertyId, Component uiContext) {
            if (propertyId.equals("remainingSeconds")) {
                countdownCombo = new CountdownCombo(parentView);
                countdownCombo.setCaption(Messages.getString("Field.CountdownField.caption", CompetitionApplication.getCurrentLocale()));
                masterData.addBlackBoardListener(countdownCombo);
                return countdownCombo;
    ...
    public PublicAddressForm(SessionData masterData, EditingView parentView) {
        super();
        this.parentView = parentView;
        //app = CompetitionApplication.getCurrent();
        this.setFormFieldFactory(new PublicAddressFormFieldFactory(parentView));
    ...
    private void closeWindow() {
        ...
        masterData.removeBlackBoardListener(countdownCombo);
