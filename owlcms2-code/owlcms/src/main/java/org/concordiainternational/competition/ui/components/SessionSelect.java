...
public class SessionSelect extends HorizontalLayout implements Serializable {
     ...
     * @return
     */
    public SessionSelect(final CompetitionApplication app, final Locale locale, final Bookmarkable view) {
    ...
    public void select(Serializable selectedId1) {
        sessionSelect.select(selectedId1);
    }

    public void setSelectedItem(final Serializable selectedValue) {
