 ...
 *
 */
public class WeighInSheetReader implements InputSheet, LifterReader {

    protected static final String TEMPLATE_XLS = "/WeighInSheetTemplate.xls"; //$NON-NLS-1$
    @SuppressWarnings("unused")
    private static final Logger logger = LoggerFactory.getLogger(WeighInSheetReader.class);
    ...
    public List<Lifter> getLifters(boolean excludeNotWeighed) {
        return LifterSorter.displayOrderCopy(Lifter.getAll(excludeNotWeighed));
    }
