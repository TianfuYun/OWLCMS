...
<%
	java.util.Locale PAGE_LOCALE = java.util.Locale.forLanguageTag("es-ES");
...
<c:choose>
	<c:when test='${useGroupName}'>
		<span class="title">Grupo ${groupName} Marcador</span>
...
<table>
	<thead>
		<tr>
			...
			<th class='weight'>Peso solicitado</th>
			<th>Try</th>
			<th class='narrow'>Equipo</th>
