...
%>
<title>Resultater - Results</title>
...
<c:choose>
	<c:when test='${useGroupName}'>
		<span class="title">Resultater Gruppe: ${groupName} &ndash; Group ${groupName} Results</span>
		<span class="liftsDone">${liftsDone}</span>
	</c:when>
	<c:otherwise>
		<span class="title">Resultater &ndash; Results</span>
		<span class="liftsDone">${liftsDone}</span>
	</c:otherwise>
</c:choose>
</div>
