...
%>
<title>Top 5 Sinclair Resultater - Top 5 Sinclair Results</title>
...
<body>
<div class="title">
		<span class="title">Top 5 Sinclair Resultater &ndash; Top 5 Sinclair Results</span>
</div>
...
<table>
    <thead>
        <tr>
            ...
            <th class="cat" style='text-align: center'>Mangler (kg)<div class='english'>kg Needed</div></th>
        </tr>
    </thead>
    <tbody>
        <% if (sortedWomen.size() > 0) { %>
	        <tr>
	            <c:choose>
	                <c:when test="${isMasters}">
	                    <td colspan="15"><nobr>Kvinder</nobr><div class='english'><nobr>Women</nobr></div></td>
	                </c:when>
	                <c:otherwise>
	                    <td colspan="14"><nobr>Kvinder</nobr><div class='english'><nobr>Women</nobr></div></td>
	                </c:otherwise>
	            </c:choose>
	        </tr>
        <% } %>
        ...
        <% if (sortedMen.size() > 0) { %>
	        <tr>
	            <c:choose>
	                <c:when test="${isMasters}">
	                    <td colspan="15"><nobr>Mænd</nobr><div class='english'><nobr>Men</nobr></div></td>
	                </c:when>
	                <c:otherwise>
	                    <td colspan="14"><nobr>Mænd</nobr><div class='english'><nobr>Men</nobr></div></td>
	                </c:otherwise>
	            </c:choose>
	        </tr>
        <% } %>
