...
%>
<title>5 Meilleurs résultats Sinclair - Top 5 Sinclair Results</title>
...
<body>
<div class="title">
        <span class="title">5 Meilleurs résultats Sinclair &ndash; Top 5 Sinclair Results</span>
</div>
...
<table>
    <thead>
        <tr>
            ...
            <th class="cat">Cat.<div class='english'>Cat.</div></th>
            <th class='weight'>P.C.<div class='english'>B.W.</div></th>
            <th class='club'>Club<div class='english'>Team</div></th>
            <th colspan="3">Arr.<div class='english'>Snatch</div></th>
            <th colspan="3">É.-J.<div class='english'>Clean&amp;Jerk</div></th>
            <th>Total<div class='english'>Total</div></th>
            <th>Sinclair<div class='english'></div></th>
            <th class="cat" style='text-align: center'>Rang<div class='english'>Rank</div></th>
            <th class="cat" style='text-align: center'>kg Requis<div class='english'>kg Needed</div></th>
        </tr>
    </thead>
    <tbody>
        <% if (sortedWomen.size() > 0) { %>
            <tr>
                <c:choose>
                    <c:when test="${isMasters}">
                        <td colspan="15"><nobr>Femmes</nobr><div class='english'><nobr>Women</nobr></div></td>
                    </c:when>
                    <c:otherwise>
                        <td colspan="14"><nobr>Femmes</nobr><div class='english'><nobr>Women</nobr></div></td>
                    </c:otherwise>
                </c:choose>
            </tr>
        <% } %>
        ...
        <% if (sortedMen.size() > 0) { %>
            <tr>
                <c:choose>
                    <c:when test="${isMasters}">
                        <td colspan="15"><nobr>Hommes</nobr><div class='english'><nobr>Men</nobr></div></td>
                    </c:when>
                    <c:otherwise>
                        <td colspan="14"><nobr>Hommes</nobr><div class='english'><nobr>Men</nobr></div></td>
                    </c:otherwise>
                </c:choose>
            </tr>
        <% } %>
