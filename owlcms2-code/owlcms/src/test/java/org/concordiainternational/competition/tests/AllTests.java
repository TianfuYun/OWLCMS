...
@RunWith(Suite.class)
@Suite.SuiteClasses( { CategoryLookupTest.class, GroupLookupTest.class, LifterEditorTest.class, LifterSorterTest.class, LifterTest.class, SpreadsheetTest.class, TwoMinutesRuleTest.class, CSVTest.class })
public class AllTests implements HbnSessionManager {
    ...
    public static String longDump(List<Lifter> lifterList) {
        StringBuffer sb = new StringBuffer();
        for (Lifter lifter : lifterList) {
            sb.append(ExtenXLSReader.toString(lifter,false));
            sb.append(AllTests.lineSeparator);
        }
        return sb.toString();
    }
    ...
    static String longDump(List<Lifter> lifterList, boolean includeTimeStamp) {
        StringBuffer sb = new StringBuffer();
        for (Lifter lifter : lifterList) {
            sb.append(ExtenXLSReader.toString(lifter, includeTimeStamp));
            sb.append(AllTests.lineSeparator);
        }
        return sb.toString();
    }
