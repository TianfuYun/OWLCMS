...
<c:choose>
	<c:when test='${useGroupName}'>
		<span class="title">Group ${groupName} Results</span>
...
<table>
	<thead>
		<tr>
			...
			<th class='club'>Division</th>
			<th colspan="3">Snatch</th>
			<th colspan="3">Clean&amp;Jerk</th>
			<th>Total</th>
			<th class="cat" style='text-align: center'>SMF</th>
		</tr>
	</thead>
	<tbody>
		<c:forEach var="lifter" items="${lifters}">
			...
			<tr>
				...
				<c:choose>
					<c:when test="${lifter.total > 0}">
						<td class='cat'><fmt:formatNumber value="${lifter.smm}" maxFractionDigits="3"/></td>
					</c:when>
					<c:otherwise>
