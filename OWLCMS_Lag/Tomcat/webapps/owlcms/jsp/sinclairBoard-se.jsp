...
<body>
<div class="title">
        <span class="title">Topp 5 Sinclair</span>
</div>
...
<table>
    <thead>
        <tr>
            ...
            <th class="cat" style='text-align: center'>behövda kg</th>
        </tr>
    </thead>
    <tbody>
        <% if (sortedWomen.size() > 0) { %>
            <tr>
                <c:choose>
                    <c:when test="${isMasters}">
                        <td colspan="15">Damer</td>
                    </c:when>
                    <c:otherwise>
                        <td colspan="14">Damer</td>
                    </c:otherwise>
                </c:choose>
            </tr>
        <% } %>
        ...
        <% if (sortedMen.size() > 0) { %>
            <tr>
                <c:choose>
                    <c:when test="${isMasters}">
                        <td colspan="15">Herrar</td>
                    </c:when>
                    <c:otherwise>
                        <td colspan="14">Herrar</td>
                    </c:otherwise>
                </c:choose>
            </tr>
        <% } %>
